(function() {
  ...
  Buffer = (function(_super) {
    ...
    Buffer.prototype._writeArrayItem = function(dataArray, result) {
      var data;
      data = dataArray.shift();
      return this.writeAsync(data).then((function(_this) {
        return function() {
          if (dataArray.length === 0) {
            return result.resolve();
          }
          return _this._writeArrayItem(dataArray, result);
        };
      })(this));
    };

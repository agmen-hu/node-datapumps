(function() {
  ...
  Buffer = (function(_super) {
    ...
    Buffer.prototype.writeArrayAsync = function(dataArray) {
      ...
      this._writeArrayItem(dataArray, result);
      return result.promise;
    };

    Buffer.prototype._writeArrayItem = function(dataArray, pendingPromise) {
      return this.writeAsync(dataArray.shift()).done((function(_this) {
        return function() {
          if (dataArray.length === 0) {
            return pendingPromise.resolve();
          }
          return _this._writeArrayItem(dataArray, pendingPromise);
        };
      })(this));
    };

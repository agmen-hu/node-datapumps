(function() {
  ...
  module.exports = Group = (function(_super) {
    ...
    Group.prototype.logErrorsToConsole = function() {
      this.whenFinished().then((function(_this) {
        return function() {
          var error, name, _i, _len, _ref, _ref1, _results;
          if (!_this.errorBuffer().isEmpty()) {
            console.log('Errors during processing:');
            _ref = _this.errorBuffer().getContent();
            _results = [];
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              error = _ref[_i];
              name = (_ref1 = error.pump) != null ? _ref1 : '(root)';
              _results.push(console.log(" - In pump " + name + ": " + error.message));
            }
            return _results;
          }
        };
    ...
    Group.prototype.writeError = function(err) {

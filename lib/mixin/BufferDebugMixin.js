(function() {
  module.exports = function(pump) {
    var clearBufferStats, collectBuffers, delay, dumpStats, hadTraffic, listenToBuffersEvents, monitorBuffers, _bufferStats, _start;
    ...
    dumpStats = function() {
      ...
      process.stdout.write("[" + ((_ref = pump.id()) != null ? _ref : '(root)') + "] ");
      for (name in _bufferStats) {
        buffer = _bufferStats[name];
